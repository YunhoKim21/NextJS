...
export default function App() {
    ...
    useEffect(() => {
        ...
        while (left.length) {
            ...
            while (true) {
                ...
                if (ccw(...stack[stack.length - 2], ...stack[stack.length - 1], ...current) > 0){ //yes
    ...
    return (
        <>
            ...
            <p>Following js code generates convex hull, using Graham scan algorithm. The whole process takes O(nlogn) time complexity.</p>
            <div className=" pace-items-center m-5 justify-center rounded-2xl bg-gray-100 p-5 h-screen" >
